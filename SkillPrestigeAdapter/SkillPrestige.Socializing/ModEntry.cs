...
namespace SkillPrestige.Socializing
{
    internal class ModEntry : Mod, ISpaceCoreSkillMod
    {
        ...
        private const string TargetModId = "drbirbdev.SocializingSkill";
        public string SpaceCoreSkillId => "drbirbdev.Socializing";

        /// <summary>The name to display for the mod in the log.</summary>
        public string DisplayName { get; } = "Socializing Skill";
        ...
        {
            this.SkillType = new SkillType("Socializing", 15)
            {
