...
namespace SkillPrestige.SnSWitchcraft
{
    internal class WitchcraftSkillAdapterSnS : Mod, ISpaceCoreSkillMod
    {
        ...
        private const string TargetModId = "KCC.SnS";
        public string SpaceCoreSkillId => "DestyNova.SwordAndSorcery.Witchcraft";

        /// <summary>The name to display for the mod in the log.</summary>
        public string DisplayName { get; } = "Witchcraft Skill of SnS";
        ...
        {
            this.SkillType = new SkillType("Witchcraft", 14)
            {
