...
namespace SkillPrestige.SnSBard
{
    internal class BardSkillAdapterSnS : Mod, ISpaceCoreSkillMod
    {
        ...
        public string SpaceCoreSkillId => "DestyNova.SwordAndSorcery.Bardics";

        /// <summary>The name to display for the mod in the log.</summary>
        public string DisplayName { get; } = "Bard Skill of SnS";
        ...
        {
            this.SkillType = new SkillType("Bard", 11)
            {
