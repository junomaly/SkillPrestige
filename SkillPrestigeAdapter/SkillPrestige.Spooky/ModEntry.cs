...
namespace SkillPrestige.Spooky
{
    internal class ModEntry : Mod, ISpaceCoreSkillMod
    {
        ...
        private const string TargetModId = "moonslime.SpookySkill";
        public string SpaceCoreSkillId => "moonslime.Spooky";

        /// <summary>The name to display for the mod in the log.</summary>
        public string DisplayName { get; } = "Scaring/Thieving Skill";
        ...
        {
            this.SkillType = new SkillType("Thieving", 16)
            {
