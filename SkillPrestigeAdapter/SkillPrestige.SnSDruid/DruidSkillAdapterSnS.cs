...
namespace SkillPrestige.SnSDruid
{
    internal class DruidSkillAdapterSnS : Mod, ISpaceCoreSkillMod
    {
        ...
        public string SpaceCoreSkillId => "DestyNova.SwordAndSorcery.Druidics";

        /// <summary>The name to display for the mod in the log.</summary>
        public string DisplayName { get; } = "Druid Skill of SnS";
        ...
        {
            this.SkillType = new SkillType("Druid", 12)
            {
