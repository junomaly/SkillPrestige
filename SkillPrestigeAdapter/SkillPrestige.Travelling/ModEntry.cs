...
namespace SkillPrestige.travelling
    {
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
            ...
            private const string TargetModId = "Achtuur.StardewTravelSkill";
            public string SpaceCoreSkillId => "Achtuur.Travelling";

            /// <summary>The name to display for the mod in the log.</summary>
            public string DisplayName { get; } = "The travel Skill by Achtuur";
