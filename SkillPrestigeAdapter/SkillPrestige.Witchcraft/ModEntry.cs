...
namespace SkillPrestige.Wizardry
{
...
#pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        private const string TargetModId = "HeyImAmethyst.ArsVenefici";
        public string SpaceCoreSkillId => "HeyImAmethyst.Wizardry";

        /// <summary>The name to display for the mod in the log.</summary>
        public string DisplayName { get; } = "Wizardry Skill from Ars Venifici";
        ...
        {
            this.SkillType = new SkillType("Wizardry", 9)
            {
