...
namespace SkillPrestige.Binning
{
    internal class ModEntry : Mod, ISpaceCoreSkillMod
    {
        ...
        private const string TargetModId = "drbirbdev.BinningSkill";
        public string SpaceCoreSkillId => "drbirbdev.Binning";

        /// <summary>The name to display for the mod in the log.</summary>
        public string DisplayName { get; } = "Binning Skill";
        ...
        {
            this.SkillType = new SkillType("Binning", 18)
            {
