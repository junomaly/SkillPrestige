...
namespace SkillPrestige.Luck_moonslime
{
    ...
    internal class ModEntry : Mod, ISpaceCoreSkillMod
    {
        ...
        private const string TargetModId = "moonslime.LuckSkill";
        public string SpaceCoreSkillId => "moonslime.Luck";

        /// <summary>The name to display for the mod in the log.</summary>
        public string DisplayName { get; } = "A Spacecore version of the luck skill";
        ...
        {
            this.SkillType = new SkillType("Luck", 7)
            {
