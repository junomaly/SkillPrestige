...
namespace SkillPrestige.Archaeology
{
    internal class ModEntry : Mod, ISpaceCoreSkillMod
    {
        ...
        private const string TargetModId = "moonslime.ArchaeologySkill";
        public string SpaceCoreSkillId => "moonslime.Archaeology";

        /// <summary>The name to display for the mod in the log.</summary>
        public string DisplayName { get; } = "Archaeology Skill";
        ...
        {
            this.SkillType = new SkillType("Archaeology", 17)
            {
